...
<script>
(function () {
	var uploadUrl = @json(route('admin.projects.tinymce-upload'));
	...
	tinymce.init(Object.assign({}, editorBase, {
		selector: '#project_body',
		height: 480
	}));

	if (document.getElementById('project_developer_about')) {
		tinymce.init(Object.assign({}, editorBase, {
			selector: '#project_developer_about',
			height: 280
		}));
	}

	document.getElementById('project_page_form')?.addEventListener('submit', function () {
