...
<div class="page-wrapper">
	<div class="page-content">
		<div class="page-breadcrumb d-sm-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
			<div class="breadcrumb-title pe-3 mb-0">FAQ management</div>
		...
		<div class="card radius-10">
			<div class="card-body">
				<p class="text-secondary small mb-3">Manage FAQ items for use on the site when you add a public FAQ page or section. Sorting and search run on the server for fast loading.</p>
				<div class="table-responsive">
					<table class="table table-hover align-middle mb-0 w-100" id="faqTable" style="width:100%">
...
$(function () {
	$('#faqTable').DataTable({
		processing: true,
		serverSide: true,
		ajax: @json(route('admin.faqs.data')),
		order: [[0, 'asc']],
		pageLength: 25,
