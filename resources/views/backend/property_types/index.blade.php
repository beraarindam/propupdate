...
<div class="page-wrapper">
	<div class="page-content">
		<div class="page-breadcrumb d-sm-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
			<div class="breadcrumb-title pe-3 mb-0">Property types</div>
			<a href="{{ route('admin.property_types.create') }}" class="btn btn-primary btn-sm">Add type</a>
		</div>
		...
		<div class="card radius-10">
			<div class="card-body">
				<p class="text-secondary small mb-3">Structural types (apartment, villa, etc.). Server-side search and paging.</p>
				<div class="table-responsive">
					<table class="table table-hover align-middle mb-0 w-100" id="propertyTypesTable" style="width:100%">
...
$(function () {
	$('#propertyTypesTable').DataTable({
		processing: true,
		serverSide: true,
		ajax: @json(route('admin.property_types.data')),
		order: [[0, 'asc']],
		pageLength: 25,
