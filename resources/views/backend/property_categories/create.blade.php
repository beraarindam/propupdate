...
<div class="page-wrapper">
	<div class="page-content pb-5">
		...
		<form action="{{ route('admin.property_categories.store') }}" method="post" enctype="multipart/form-data">
			@csrf
