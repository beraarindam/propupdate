...
<div class="page-wrapper">
	<div class="page-content">
		<div class="page-breadcrumb d-sm-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
			<div class="breadcrumb-title pe-3 mb-0">Property categories</div>
			<a href="{{ route('admin.property_categories.create') }}" class="btn btn-primary btn-sm">Add category</a>
		</div>
		...
		<div class="card radius-10">
			<div class="card-body">
				<p class="text-secondary small mb-3">Parent and child categories, each with its own image. Server-side search and paging.</p>
				<div class="table-responsive">
					<table class="table table-hover align-middle mb-0 w-100" id="propertyCategoriesTable" style="width:100%">
...
<script>
$(function () {
	$('#propertyCategoriesTable').DataTable({
		processing: true,
		serverSide: true,
		ajax: @json(route('admin.property_categories.data')),
		order: [[0, 'asc']],
		pageLength: 25,
