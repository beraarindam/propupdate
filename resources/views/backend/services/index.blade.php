...
<div class="page-wrapper">
	<div class="page-content">
		<div class="page-breadcrumb d-sm-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
			<div class="breadcrumb-title pe-3 mb-0">Service management</div>
		...
		<div class="card radius-10">
			<div class="card-body">
				<p class="text-secondary small mb-3">Published services appear on the homepage. Search and paging are server-side for speed.</p>
				<div class="table-responsive">
					<table class="table table-hover align-middle mb-0 w-100" id="servicesTable" style="width:100%">
...
$(function () {
	$('#servicesTable').DataTable({
		processing: true,
		serverSide: true,
		ajax: @json(route('admin.services.data')),
		order: [[0, 'asc']],
		pageLength: 25,
