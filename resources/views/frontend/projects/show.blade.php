          ...
          <div class="pu-pd-request card border-0 shadow-lg mt-4 pu-prj-cta-card" id="pu-project-request">
            ...
            <div class="card-body pu-pd-request__body">
              ...
              <form method="post" action="{{ route('projects.enquiry', $project) }}" novalidate>
                ...
                <div class="mb-3">
                  <label for="pu-prj-enq-phone" class="form-label small fw-semibold text-muted mb-1">Phone</label>
                  <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="pu-prj-enq-phone" name="phone" value="{{ old('phone') }}" required maxlength="32" autocomplete="tel">
