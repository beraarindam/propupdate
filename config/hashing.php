...
return [
    ...
    */
    ...
    'bcrypt' => [
        ...
        // When true, login throws if the DB hash is not bcrypt (e.g. Argon2 or legacy imports). Set true after all passwords are bcrypt; use HASH_VERIFY in .env to override.
